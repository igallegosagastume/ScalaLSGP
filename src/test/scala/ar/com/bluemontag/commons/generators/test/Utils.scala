...
object Utils {
   ...
   * @param path
   */
  def computeTimeFor(generator: AbstractLSGenerator, progress: Int, showProgress: Boolean, showFinalMessage: Boolean, verbose: Boolean): Double = {
    ...
    def repeatGeneration(generator: AbstractLSGenerator, times: Int): Unit = {
    var startTime = System.nanoTime();
